...
//! ## Overview
//!
//! The Hotstuff module extends Hotstuff consensus by managing offline reporting.
//!
//! ## Interface
//!
//! ### Public Functions
//!
//! - `slot_duration` - Determine the Hotstuff slot-duration based on the Timestamp module
//!   configuration.
//!
//! ## Related Modules
//!
//! - [Timestamp](../pallet_timestamp/index.html): The Timestamp module is used in Hotstuff to track
...
///
/// This was the default behavior of the Hotstuff pallet and may be used for
...
pub mod pallet {
	...
	pub trait Config: pallet_timestamp::Config + frame_system::Config {
		...
		/// The slot duration Hotstuff should run with, expressed in milliseconds.
...
impl<T: Config> Pallet<T> {
	...
	/// And hotstuff consensus log will be appended to block's log.
	///
	...
	/// Determine the Hotstuff slot-duration based on the Timestamp module configuration.
...
/// Find the authority ID of the Hotstuff authority who authored the current block.
pub type HotstuffAuthorId<T> = FindAccountFromAuthorIndex<T, Pallet<T>>;
...
impl<T: Config> OnTimestampSet<T::Moment> for Pallet<T> {
	fn on_timestamp_set(moment: T::Moment) {
		...
		assert!(!slot_duration.is_zero(), "Hotstuff slot duration cannot be zero.");
